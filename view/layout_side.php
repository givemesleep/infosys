      ...
      <div class="navbar-vertical-footer-offset">
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <span class="dropdown-header"><b>Information Management</b></span>
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a class="nav-link " href="./mem-masterlist.php" data-placement="left">
                  <i class="bi bi-people-fill nav-icon"></i>
                  <span class="nav-link-title">Member Masterlist</span>
                </a>
              </div>
              ...
              <div class="nav-item">
                <a class="nav-link " href="./" data-placement="left">
                  ...
                  <span class="nav-link-title">Find Member</span>
                </a>
              </div>
            </div>
            <!-- End Collapse -->
