          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                ...
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;"><b>Member Masterlist</b></a></li>
              </ol>
            </nav>

            <h1 class="page-header-title">Member Masterlist</h1>
          </div>
        </div>
      </div>
      <!-- End Page Header -->
          ...
          <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
            ...
            <thead class="thead-light">
              <tr>
                ...
                <th style="width: 15%;" class="table-column-ps-0">Name</th>
            ...
            <tbody>
              <tr>
                <td class="table-column-pe-0">001</td>
                <td class="table-column-ps-0">Justice Bellen</td>
                <td>Llano caloocan </td>
                <td>Llano</td>
                <td>2025</td>
                <td>May 18 2025</td>
                <td> <span class="legend-indicator bg-success"></span>Active</td>
                <td>
                    <a href=""><button class="btn btn-soft-dark">View</button></a>
                    <a href=""><button class="btn btn-soft-success">Edit</button></a>
                    <a href=""><button class="btn btn-soft-danger">Archive</button></a>
                </td>
              </tr>

              <tr>
                <td class="table-column-pe-0">002</td>
                <td class="table-column-ps-0">Pia Mabutin</td>
